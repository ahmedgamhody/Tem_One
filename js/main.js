...
$(document).ready(function () {
  $(".tech ul li").on("click", function () {
    if (!$(this).hasClass("active")) {
      var className = $(this).attr("class");
      $(".tech ul li").removeClass("active");
      $(this).addClass("active");
      $(".tech img").css("display", "none");
      $(".tech ." + className).fadeIn();
    }
  });
});
/////////////////////// last slider //////
let scrollContainer = document.querySelector(".featured .gallery");
let scrollContainerNextBtn = document.getElementById("next-last-slider");
let scrollContainerPrevBtn = document.getElementById("prev-last-slider");
...
scrollContainerNextBtn.addEventListener("click", () => {
  scrollContainer.style.scrollBehavior = "smooth";
  scrollContainer.scrollLeft += 900;
});
scrollContainerPrevBtn.addEventListener("click", () => {
  scrollContainer.style.scrollBehavior = "smooth";
  scrollContainer.scrollLeft -= 900;
});
////////////////////////////btn up actions
